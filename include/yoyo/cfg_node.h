...
public:
    ...
    static CFGNode* prepareFromFunction(CFGNodeManager& mgr,
...
public:
    ...
    /// this stores the first and last uses of every local variable and is
    /// filled after @c annotate is called
