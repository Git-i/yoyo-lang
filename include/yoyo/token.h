...
struct Token {
    ...
    [[nodiscard]] bool is_assignment() const {
        ...
        return as_int >= static_cast<std::underlying_type_t<TokenType>>(
                             TokenType::Equal) &&
               as_int <= static_cast<std::underlying_type_t<TokenType>>(
                             TokenType::CaretEqual);
    }
    [[nodiscard]] bool can_be_overloaded() const {
        return type == TokenType::Plus || type == TokenType::Minus ||
               type == TokenType::Slash || type == TokenType::Star ||
               ...
               type == TokenType::DoubleLess || type == TokenType::Ampersand;
    }
    [[nodiscard]] bool can_be_overloaded_binary_only() const {
        return type == TokenType::Plus || type == TokenType::Slash ||
               type == TokenType::Star || type == TokenType::Percent ||
               type == TokenType::Ampersand || type == TokenType::Pipe ||
               type == TokenType::Caret || type == TokenType::Spaceship ||
               type == TokenType::DoubleGreater ||
